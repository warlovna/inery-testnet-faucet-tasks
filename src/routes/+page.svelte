...
<div class="container bg-base-200 mx-auto min-h-screen px-20 pb-20 pt-20">
    <div class="mb-10 text-center">
        <div class="text-4xl font-bold text-white">INERY SIMPLE CRUD DAPP</div>
        <div class="text-2xl font-medium text-white">by wardy</div>
        <div class="mt-4 text-white italic">Please click one of button below to run the blockchain transaction <br> after the transaction executed you will see a blockchain log in the bottom</div>
    </div>

    <div class="grid grid-cols-4 gap-4">
        <label for="modal-create" class="btn btn-success font-extrabold">Create</label>
        ...
        <label for="modal-destroy" class="btn btn-success font-extrabold">Destroy</label>
    </div>
