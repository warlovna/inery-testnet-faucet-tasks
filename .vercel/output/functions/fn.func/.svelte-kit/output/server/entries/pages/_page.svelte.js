...
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { action_button_class = "btn btn-info font-bold" } = $$props;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container bg-base-200 mx-auto min-h-screen px-20 pb-20 pt-20"}"><div class="${"mb-10 text-center"}"><div class="${"text-4xl font-bold text-white"}">INERY SIMPLE CRUD DAPP</div>
        <div class="${"text-2xl font-medium text-white"}">by wardy</div>
        <div class="${"mt-4 text-white italic"}">Please click one of button below to run the blockchain transaction <br> after the transaction executed you will see a blockchain log in the bottom</div></div>

    <div class="${"grid grid-cols-4 gap-4"}"><label for="${"modal-create"}" class="${"btn btn-success font-extrabold"}">Create</label>
        <label for="${"modal-read"}" class="${"btn btn-success font-extrabold"}">Read</label>
        <label for="${"modal-update"}" class="${"btn btn-success font-extrabold"}">Update</label>
        <label for="${"modal-destroy"}" class="${"btn btn-success font-extrabold"}">Destroy</label></div>
...
${validate_component(Modal, "Modal").$$render(
    ...
    {
      body: () => {
        return `<div slot="${"body"}" class="${"flex flex-col gap-2"}"><input type="${"text"}" placeholder="${"Type the ID..."}" class="${"input input-bordered w-full max-w-xs"}"${add_attribute("value", create_id, 0)}>
...
${validate_component(Modal, "Modal").$$render(
    ...
    {
      body: () => {
        return `<div slot="${"body"}" class="${"flex flex-col gap-2"}"><input type="${"text"}" placeholder="${"Type the ID..."}" class="${"input input-bordered w-full max-w-xs"}"${add_attribute("value", read_id, 0)}></div>`;
      }
    }
  )}
...
${validate_component(Modal, "Modal").$$render(
    ...
    {
      body: () => {
        return `<div slot="${"body"}" class="${"flex flex-col gap-2"}"><input type="${"text"}" placeholder="${"Type the ID..."}" class="${"input input-bordered w-full max-w-xs"}"${add_attribute("value", update_id, 0)}>
        <textarea class="${"textarea textarea-bordered w-full"}" placeholder="${"Type the data..."}">${""}</textarea></div>`;
      }
    }
  )}
...
${validate_component(Modal, "Modal").$$render(
    ...
    {
      body: () => {
        return `<div slot="${"body"}" class="${"flex flex-col gap-2"}"><input type="${"text"}" placeholder="${"Type the ID..."}" class="${"input input-bordered w-full max-w-xs"}"${add_attribute("value", destroy_id, 0)}></div>`;
      }
    }
  )}`;
});
